...
/**
 * @brief Calculates intersection point of two particles in a collision.
 * @param p1 Struct for particle 1.
 * @param p2 Struct for particle 2.
 * @return reb_3d struct containing x, y, z coordinates of impact point.
 */

// Helper functions for tidal merging routine
struct reb_vec3d intersection(const struct reb_particle p1, const struct reb_particle p2);

/**
 * @brief Calculates the Hill radius.
 * @param p1 Struct for particle 1.
 * @param p2 Struct for particle 2.
 ...
 * @param eps_n Coefficient of restitution in the normal direction. 
 * @param vel_n Velcoity in the normal direction.  
 * @param eps_t Coefficient of restitution in the tangential direction. 
 * @param vel_t Velocity in the tangential direction.
 * @param vel_impact Relative impact velocity between particles.
 * @return Effective coefficient of restitution. 
 */
 ...
 * @param r Struct for rebound simulation. 
 * @param c Collision struct.
 ...
 * @details Merges particle with higher index into particle of lower index if
 *          the Jacobi energy is < 0.
 *          Conserves mass, momentum and volume.  
 */
