...
/**
 * @brief Calculates angular momentum of a particle
 * @param r REBOUND Simulation to consider
 * @param i Index of particle to remove
 * @param ang_scale Units of angular momentum
 */

void write_to_file(struct reb_vec3d ang_mom);
/**
 * @brief Right angular momentum to file of particle leaving simulation box
 * @param ang_mom The angular momentum of the particle
 */
